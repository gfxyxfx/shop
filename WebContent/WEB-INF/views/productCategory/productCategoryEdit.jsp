					...
					<div class="row">
							<div class="hpanel">
								...
								<form id="form_productCategory" name="form_productCategory" action='<c:url value="/admin/save?${_csrf.parameterName}=${_csrf.token}" />'  method="POST">
									...
									<div class="form-group col-lg-12">
										<label>排序</label>
										<input type="text" id="sortOrder" name="sortOrder" class="form-control" maxlength="50" placeholder="排序" value='${productCategory.sortOrder}' />
									</div>
									<div class="form-group col-lg-12">
										<label>图片</label>
									...
									<div class="form-group col-lg-12">
										<label>描述</label>
										<textarea rows="3" cols="20" id="description" name="description" class="form-control" maxlength="50" ></textarea>
	...
	$("#save").bind("click",function(){
		...
		$.ajax({
			...
			success : function(json) {
				$("#createTime").val(json.data.createTime);
