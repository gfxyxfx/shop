	...
	<div class="small-header transition">
								...
								<div id="error_div" class="text-left"></div>
									<form id="form_productCategory" name="form_productCategory" action="" method="POST">
										<div class="form-group col-lg-6">
											<label>商品类别名</label>
												<input type="text" id="name" name="name" class="form-control" maxlength="50" placeholder="商品类别名"/>	
										</div>
										<div class="form-group col-lg-6">
											<label>描述</label>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="hpanel">
					<div class="panel-body">
						<table id="productCategoryList" style="width: 100%;" class="table table-striped table-bordered table-hover"></table>
					</div>
				</div>
			</div>
		</div>
